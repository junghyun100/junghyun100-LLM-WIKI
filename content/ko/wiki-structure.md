...
> 📚 **참고**: [Quartz 설정](https://quartz.jzhao.xyz/configuration) · [Quartz 레이아웃](https://quartz.jzhao.xyz/layout) · [Crawl-links 플러그인](https://github.com/jackyzha0/quartz/tree/v5/quartz/plugins/transformers/crawl-links)
