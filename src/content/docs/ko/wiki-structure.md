...
> 📚 **참고**: [Starlight 구성 가이드 (사이드바)](https://starlight.astro.build/reference/configuration/#sidebar) · [Starlight 다국어](https://starlight.astro.build/guides/i18n/) · [Astro 콘텐츠 컬렉션](https://docs.astro.build/en/guides/content-collections/)
